package vuvibsign.security.infrastructure.gateway.jwt;
...
public class JwtUtils {
    ...
    public ResponseCookie generateJwtCookie(UserDetailsAdapter userPrincipal) {
